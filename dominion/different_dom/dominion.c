...
int validAmbassadorEffect(struct gameState *state, int choice1,int choice2,int currentPlayer,int handPos){
	int retVal = 0;
	int i = 0;
	int j = 0;
...
int ambassadorCardEffect(struct gameState *state,int choice1, int choice2, int currentPlayer, int handPos){
      int j = 0;		//used to check if player has enough cards to discard
	int i;
	int retVal = validAmbassadorEffect(state,choice1,choice2,currentPlayer,handPos);
	if(retVal != 0){
		return retVal;
	}
...
void baronCardEffect(struct gameState *state, int currentPlayer, int choice1){
...
int validMineCardEffect(struct gameState *state, int choice1, int choice2, int currentPlayer){
	int retVal = 0;
...
int mineCardEffect(struct gameState* state, int choice1, int choice2, int currentPlayer,int handPos){
      int j = state->hand[currentPlayer][choice1];  //store card we will trash
	int retVal = validMineCardEffect(state, choice1, choice2, currentPlayer);
	if(retVal != 0){
		return retVal;
	}
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      val = mineCardEffect(state,choice1,choice2,currentPlayer,handPos);		
      return val;
    ...
    case smithy:
      ret = smithyCardEffect(state, currentPlayer, handPos);
      return ret;
    ...
    case baron:
      baronCardEffect(state, currentPlayer, choice1);
      return 0;
    ...
    case ambassador:
	val = ambassadorCardEffect(state,choice1,choice2,currentPlayer,handPos);
      return val;
